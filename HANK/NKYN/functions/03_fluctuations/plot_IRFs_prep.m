...
IRF_Zy=100*IRF_state_sparse(mpar.numstates-3,1:end-1);
IRF_Zi=100*IRF_state_sparse(mpar.numstates-2,1:end-1);
...
IRF_ly=100*IRF_state_sparse(end-mpar.oc+12,1:end-1);
IRF_le=100*IRF_state_sparse(end-mpar.oc+13,1:end-1);
IRF_Mg=100*IRF_state_sparse(end-mpar.oc+14,1:end-1);
IRF_giniC=100*IRF_state_sparse(end-mpar.oc+15,1:end-1);
...
%% income and consumpton by wealth
